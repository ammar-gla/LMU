...
```{r, main_figures ,echo=FALSE}
  ...
  lfs_last_month <- lfs_stats %>%
    ...
    filter(sex_name == "Total"  & geography_name == "London" & value_type_name == "Level" & date_day == max(date_day) & measures == 20207) %>%
    pull(month)
  ...
  unem_pp_quart <- perc_form(lfs_stats %>%
                               filter(sex_name == "Total" & date_day == max(date_day) & geography_name == "London" 
