...
-   The most timely estimate of **payrolled employees** shows  `r condi_text(paye_d_month,"noun")` of around `r abs2(paye_d_month)`, or `r abs2(paye_p_month)`%, in London between `r paye_previous_month` and `r paye_overall_last_month` -- `r abs2(paye_p_feb20)`% `r condi_text(paye_p_feb20,"above")` pre-pandemic (February 2020) levels. 
...
-   The UK rate of economic inactivity was `r inact_rate_uk`%; this represents no change on the previous quarter and `r condi_text(inact_pp_year_uk,"noun")` of `r abs2(inact_pp_year_uk)`pp on the year.
