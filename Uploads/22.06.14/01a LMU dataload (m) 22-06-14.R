  ...
  cpih_stats <- data1 <- read.csv(paste0(INTERMEDIATE,Sys.Date(),"_raw_cpih.csv"), header=FALSE, stringsAsFactors=FALSE) %>% 
    ...
    mutate(date_day=ym(month_date),
           ...
           cpih_yoy = cpih_index_2015/lag(cpih_index_2015,n=12)-1,
           year=year(date_day),
