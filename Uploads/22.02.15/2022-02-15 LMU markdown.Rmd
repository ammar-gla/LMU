...
-   The total number of **payrolled employees** `r condi_text(paye_d_month,"rise")` by around `r abs2(paye_d_month)` in London, or `r abs2(paye_p_month)`%, between `r paye_lastmonth` and `r paye_newmonth` and is `r abs2(paye_p_feb20)`% `r condi_text(paye_p_feb20,"above")` pre-pandemic (February 2020) levels. 
...
ggsave( paste0(IMAGES,Sys.Date(),"_","paye_nuts2",".svg"), device = "svg", width = 16, height = 8, units = "in")
ggsave( paste0(IMAGES,Sys.Date(),"_","paye_nuts2",".png"), device = "png", width = 16, height = 8, units = "in")
...
ggsave( paste0(IMAGES,Sys.Date(),"_","paye_nuts2_V2",".svg"), device = "svg", width = 8, height = 8, units = "in")
ggsave( paste0(IMAGES,Sys.Date(),"_","paye_nuts2_V2",".png"), device = "png", width = 8, height = 8, units = "in")
...
Some industries have yet to recover from the pandemic. Comparing **`r newest_period_paye_ind`** to pre-pandemic levels (February 2020):
...
Recent changes in the number of payrolled employees vary by age group. Comparing **`r newest_period_paye_age`** to pre-pandemic levels (February 2020):
...
-   In the United Kingdom overall, those two age groups saw `r condi_text(paye_age_max_l_perc_uk,"noun")` of `r abs2(paye_age_max_l_perc_uk)`% and `r condi_text(paye_age_min_l_perc_uk,"noun")` of `r abs2(paye_age_min_l_perc_uk)`%, respectively.
...
There is considerable variation in the change in payrolled employees by London authority. Comparing **`r newest_period_paye_la`** to pre-pandemic levels (February 2020):
...
The overall number of Londoners in employment is still 49,000 or 1.0% below where it was before the pandemic (December 2020 to February 2021). This is likely down to a drop in self-employment (see [here](https://www.ons.gov.uk/employmentandlabourmarket/peopleinwork/employmentandemployeetypes/bulletins/employmentintheuk/latest#employment)).
