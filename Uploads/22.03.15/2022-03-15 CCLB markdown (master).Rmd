...
- Focusing on the last month, in the period up to `r cc_newmonth`, the non-seasonally adjusted claimant count `r condi_text(cc_lon_p_mar20,"rise")`  by `r abs2(cc_lon_d_mom)` (`r abs2(cc_lon_p_mom)`%). This was the first monthly increase in London since March 2021.
