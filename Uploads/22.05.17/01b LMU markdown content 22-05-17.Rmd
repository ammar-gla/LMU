...
-   London's **inactivity rate** (the measure of those not looking and/or not available to work) was estimated at `r inact_rate`%. While it remains lower than the UK-wide estimate of `r inact_rate_uk`%, it was `r condi_text(inact_pp_year,"up")` `r abs2(inact_pp_year)`pp on the previous year and  `r condi_text(inact_pp_quart,"up")` `r abs2(inact_pp_quart)`pp on the previous quarter.
...
<!-- London’s labour market has seen significant improvements since the worst of the COVD-19 pandemic with the headline unemployment rate down to pre-pandemic levels.  -->
<!-- <br><br> -->
<!-- Yet the recovery is not complete.  -->
<!-- <br><br> -->
<!-- The Claimant Count rate remains very high following its sharp increase with the onset of lockdowns and is only decreasing slowly. -->
<!-- <br><br> -->
<!-- The number of payrolled employees is up overall on pre-pandemic levels, but sectors such as hospitality and the creative industries have yet to recover.  -->
<!-- <br><br> -->
<!-- We are also seeing a possible early sign that inactivity may be back on the rise in London as the rate has now increased both on the year and the quarter. -->
<!-- ::: -->
